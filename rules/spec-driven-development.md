...
"возможно", "вероятно", "обычно", "as a rule", "etc.", "and so on", "may", "might", "should usually", "similar to", "like X". Allowed in `Context`, `Glossary`, comments. Conditional fields take a value from a closed enum; `not_applicable` requires `reason`.
